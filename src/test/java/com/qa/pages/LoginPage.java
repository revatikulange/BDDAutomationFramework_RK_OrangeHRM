...
/**
 * This class has used page factory design pattern and it has page factory
 * repositories with page operation methods
 */
public class LoginPage {
	...
	/**
	 * @param driver This is page class constructer of page factory design pattern
	 */
